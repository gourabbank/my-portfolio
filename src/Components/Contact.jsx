...
const socialLinks = [
  {
    href: 'https://github.com/gourabbank',
  ...
  {
    href: 'https://www.linkedin.com/in/gourabbank/',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    href: 'https://www.instagram.com/sirbanksal0t/',
    ...
    >
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            ...
            <div className="mb-12 lg:mb-0 lg:flex-col">
                ...
                Let’s turn data into impact! If you’re building something bold in analytics, machine learning, or cloud engineering, 
                I’d love to collaborate and help transform ideas into real-world solutions. Let’s build something brilliant together!
                </p>
                ...
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            autoComplete="email"
                            required
                            placeholder="bankgourab0@gmail.com"
                            className="text-field reveal-up"
                        />
                    </div>
